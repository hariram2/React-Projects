                                            ...
                                            <ul className="products-grid">
                                                ...
                                                <li className="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                                                    <div className="item-inner">
                                                        <div className="item-img">
                                                            <div className="item-img-info">
                                                                <a title="Retis lapen casen" className="product-image"><img src="assets/products-images/p4.jpg" alt="Retis lapen casen" /></a>
                                                                <div className="item-box-hover">
                                                                    <div className="box-inner">
                                                                        <div className="add_cart">
                                                                            <button className="button btn-cart" type="button"></button>
                                                ...
                                                <li className="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                                                    <div className="item-inner">
                                                        <div className="item-img">
                                                            <div className="item-img-info">
                                                                <a title="Retis lapen casen" className="product-image"><img src="assets/products-images/p5.jpg" alt="Retis lapen casen" /></a>
                                                ...
                                                <li className="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                                                    <div className="item-inner">
                                                        <div className="item-img">
                                                            <div className="item-img-info">
                                                                <a title="Retis lapen casen" className="product-image"><img src="assets/products-images/p7.jpg" alt="Retis lapen casen" /></a>
                                                                <div className="item-box-hover">
                                                                    <div className="box-inner">
                                                                        <div className="add_cart">
                                                                            <button className="button btn-cart" type="button"></button>
                                                ...
                                                <li className="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                                                    <div className="item-inner">
                                                        <div className="item-img">
                                                            <div className="item-img-info">
                                                                <a title="Retis lapen casen" className="product-image"><img src="assets/products-images/p9.jpg" alt="Retis lapen casen" /></a>
                                                                <div className="item-box-hover">
                                                                    <div className="box-inner">
                                                                        <div className="add_cart">
                                                                            <button className="button btn-cart" type="button"></button>
                                                ...
                                                <li className="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                                                    <div className="item-inner">
                                                        <div className="item-img">
                                                            <div className="item-img-info">
                                                                <a title="Retis lapen casen" className="product-image"><img src="assets/products-images/p10.jpg" alt="Retis lapen casen" /></a>
                                                                <div className="item-box-hover">
                                                                    <div className="box-inner">
                                                                        <div className="add_cart">
                                                                            <button className="button btn-cart" type="button"></button>
                                                ...
                                                <li className="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                                                    <div className="item-inner">
                                                        <div className="item-img">
                                                            <div className="item-img-info">
                                                                <a title="Retis lapen casen" className="product-image"><img src="assets/products-images/p11.jpg" alt="Retis lapen casen" /></a>
                                                                <div className="item-box-hover">
                                                                    <div className="box-inner">
                                                                        <div className="add_cart">
                                                                            <button className="button btn-cart" type="button"></button>
